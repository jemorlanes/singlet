...
c_nmf <- function(A, At, tol, maxit, verbose, L1_w, L1_h, L2_w, L2_h = L2_h, threads = threads, w) {
    .Call(`_singlet_c_nmf`, A, At, tol, maxit, verbose, L1_w, L1_h, L2_w, L2_h = L2_h, threads = threads, w)
}
